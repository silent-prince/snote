function savemessage(message,replyingmessageid,created_at){
...
function seenByMe(aarumiIds,is_seen_or_is_received){
    console.log("seen by me "+aarumiIds+" is_seen_or_is_received "+is_seen_or_is_received);
...
function retryFailedMessages(failedMessages){
